        ...
        <div className='row htlfndr-page-content'>
          ...
          >
            <header className='htlfndr-entry-header'>
              {' '}
              <h1 className='htlfndr-entry-title'>Hilton Hotel</h1>{' '}
              ...
              <div className='htlfndr-hotel-contacts row'>
                {' '}
                <div className='col-sm-6 col-md-6 col-lg-4'>
                  {' '}
                  <p className='htlfndr-location'>
                    <a href='#'>San Francisco United States</a>
                  </p>{' '}
                </div>{' '}
                <div className='col-sm-6 col-md-6 col-lg-4'>
                  {' '}
                ...
                <div className='col-sm-6 col-md-6 col-lg-4'>
                  {' '}
                  <p className='htlfndr-special-offer-post'>
                    special offer
                  </p>{' '}
                </div>{' '}
                <div className='col-sm-6 col-md-6 col-lg-4'>
                ...
                <aside className='htlfndr-sidebar-in-top htlfndr-short-form'>
                  ...
                  >
                    ...
                    <div id='htlfndr-input-4' className='htlfndr-input-wrapper'>
                      <label
                        htmlFor='htlfndr-dropdown-button'
                        className='sr-only'
                      >
                      ...
                      >
                        ...
                        <option value='2 adults in 1 room'>
                          2 adults in 1 room
                        </option>
                        <option value='3 adults in 1 room'>
                          3 adults in 1 room
                        </option>
                        <option value='4 adults in 1 room'>
                          4 adults in 1 room
                        </option>
                    ...
                    <div>
                      ...
                      <div className='htlfndr-post-wrapper'>
                        ...
                        <h6 className='htlfndr-post-info'>
                          Max Guests: <span className='htlfndr-guests'>7</span>{' '}
                          | Max Kids: <span className='htlfndr-kids'>3</span>
                        </h6>
                        <p className='htlfndr-post-excerpt'>
                          Lorem ipsum dolor sit amet, consectetur adipisicing
                          elit. Accusamus alias beatae debitis deserunt eius
                          esse, explicabo facilis hic!
                        </p>
              ...
              <div className='htlfndr-widget-main-content'>
                ...
                <div className='htlfdr-hotel-post'>
                  <div className='htlfndr-post-inner htlfndr-table-view'>
                    <div className='htlfndr-hotel-thumbnail'>
                      {' '}
                      <Link to='/hotel-page-v2'>
                        <img src={Img14} alt='hotel pic' />{' '}
                      </Link>{' '}
                    </div>
                    <div className='htlfndr-hotel-info'>
                      {' '}
                ...
                <div className='htlfdr-hotel-post'>
                  <div className='htlfndr-post-inner htlfndr-table-view'>
                    <div className='htlfndr-hotel-thumbnail'>
                      {' '}
                      <Link to='/hotel-page-v3'>
                        <img src={Img15} alt='hotel pic' />{' '}
                      </Link>{' '}
                    </div>
                    <div className='htlfndr-hotel-info'>
                      {' '}
                ...
                <div className='htlfdr-hotel-post'>
                  <div className='htlfndr-post-inner htlfndr-table-view'>
                    <div className='htlfndr-hotel-thumbnail'>
                      {' '}
                      <Link to='/hotel-page-v4'>
                        <img src={Img16} alt='hotel pic' />{' '}
                      </Link>{' '}
                    </div>
                    <div className='htlfndr-hotel-info'>
                      {' '}
