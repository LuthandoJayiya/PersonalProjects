...
const handleClearCheckIn = () => setCheckInDate(null)
  const handleClearCheckOut = () => setCheckOutDate(null)
    ...
    >
      <div className='htlfndr-modify-search-aside widget'>
        ...
        <div className='htlfndr-widget-content'>
          <form name='search-hotel' id='search-hotel'>
            <label htmlFor='htlfndr-city' className='htlfndr-input-label'>
              Your destination
            </label>
          ...
          >
            ...
            <section className='htlfndr-select-block'>
              <div className='htlfndr-input-wrapper htlfndr-small-select'>
                <label htmlFor='htlfndr-room-button' className='htlfndr-input-label'>
                  Room
                </label>
                <select
                  name='htlfndr-room'
              ...
              <div className='htlfndr-input-wrapper htlfndr-small-select'>
                <label htmlFor='htlfndr-adult-button' className='htlfndr-input-label'>
                  Adult
                </label>
                <select
                  name='htlfndr-adult'
              ...
              <div className='htlfndr-input-wrapper htlfndr-small-select'>
                <label htmlFor='htlfndr-kids-button' className='htlfndr-input-label'>
                  Kids
                </label>
                <select
                  name='htlfndr-kids'
      ...
      <div className='htlfndr-user-rating' data-rating={rating}>
        {[1, 2, 3, 4, 5].map((star) => (
          <i
            key={star}
            className={`fa fa-star ${star <= rating ? '' : 'htlfndr-empty-star'}`}
      ...
      />
            ...
            <p className='htlfndr-checkbox-line'>
              ...
              <label htmlFor='htlfndr-check-hotel' className='label-of-disabled-check'>
                hotel <span>(15)</span>
              </label>
            </p>
      ...
      <div className='htlfndr-search-result-sorting row'>
        <div className='col-md-12'>
          <div className='dropdown htlfndr-sort'>
            ...
            <ul className='dropdown-menu' aria-labelledby='htlfndr-sort-1'>
              <li>
          ...
          <div className='dropdown htlfndr-show-number-hotels'>
            ...
            <ul className='dropdown-menu' aria-labelledby='htlfndr-sort-2'>
              <li>
